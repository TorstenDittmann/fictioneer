...
<svelte:head>
	<title>Terms of Service - Fictioneer</title>
	<meta name="description" content="Terms of Service for using Fictioneer." />
</svelte:head>
...
<div class="relative min-h-screen overflow-hidden">
	...
	<div class="relative z-10 mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:py-24">
		...
		<div class="mb-12 text-center">
			...
			<h1 class="animate-fade-in-up font-serif text-4xl font-bold text-paper-text">
				Terms of Service
			</h1>
			<p class="animate-fade-in-up mt-4 text-paper-text-light" style:animation-delay="0.1s">
				Last updated: January 5, 2026
			</p>
		</div>

		<!-- Content -->
		<div class="prose prose-paper animate-fade-in-up" style:animation-delay="0.2s">
			<div class="card-elevated space-y-8 p-8">
				<p class="text-paper-text-light">
					Please read these terms and conditions carefully before using Our Service.
				</p>

				<section>
					<h2 class="font-serif text-xl font-semibold text-paper-text">Acknowledgment</h2>
				...
				<section>
					<h2 class="font-serif text-xl font-semibold text-paper-text">User Accounts</h2>
					<p class="mt-3 text-paper-text-light">
					...
					<p class="mt-3 text-paper-text-light">
						...
						or entity other than you without appropriate authorization, or a name that is otherwise
						offensive, vulgar, or obscene.
					</p>
				</section>

				<section>
					<h2 class="font-serif text-xl font-semibold text-paper-text">Copyright Policy</h2>
					<div class="mt-3 space-y-4 text-paper-text-light">
						<h3 class="font-medium text-paper-text">Intellectual Property Infringement</h3>
						<p>
							All content, features, and functionality of our services, including but not limited to
							text, graphics, logos, and software, are the exclusive property of
							<strong class="text-paper-text">Fictioneer</strong> and are protected by international copyright,
							trademark, and other intellectual property laws.
						</p>

						<h3 class="mt-4 font-medium text-paper-text">
							DMCA Notice and DMCA Procedure for Copyright Infringement Claims
						</h3>
						<p>
							You may submit a notification pursuant to the Digital Millennium Copyright Act (DMCA)
							by providing our Copyright Agent with the following information in writing (see 17
						...
						<p class="mt-3">
							...
							<a href="mailto:support@fictioneer.app" class="text-paper-accent hover:underline">
								support@fictioneer.app
							</a>
							. Upon receipt of a notification, the Company will take whatever action, in its sole discretion,
							it deems appropriate, including removing the challenged content from the Service.
						</p>
					</div>
				</section>

				<section>
					<h2 class="font-serif text-xl font-semibold text-paper-text">Intellectual Property</h2>
					<p class="mt-3 text-paper-text-light">
				...
				<section>
					<h2 class="font-serif text-xl font-semibold text-paper-text">Your Feedback to Us</h2>
					<p class="mt-3 text-paper-text-light">
						...
						use, reproduce, disclose, sublicense, distribute, modify, and exploit such Feedback
						without restriction.
					</p>
				</section>

				<section>
					<h2 class="font-serif text-xl font-semibold text-paper-text">Links to Other Websites</h2>
					<p class="mt-3 text-paper-text-light">
				...
				<section>
					<h2 class="font-serif text-xl font-semibold text-paper-text">Termination</h2>
					<p class="mt-3 text-paper-text-light">
				...
				<section>
					<h2 class="font-serif text-xl font-semibold text-paper-text">Limitation of Liability</h2>
					<p class="mt-3 text-paper-text-light">
					...
					<h3 class="mt-4 font-medium text-paper-text">"AS IS" and "AS AVAILABLE" Disclaimer</h3>
					<p class="mt-3 text-paper-text-light">
					...
					<p class="mt-3 text-paper-text-light">
						Without limitation to the foregoing, the Company provides no warranty or undertaking,
						and makes no representation of any kind that the Service will meet Your requirements,
				...
				<section>
					<h2 class="font-serif text-xl font-semibold text-paper-text">Governing Law</h2>
					<p class="mt-3 text-paper-text-light">
						The laws of <strong class="text-paper-text">Georgia</strong>, excluding its conflicts of
						law rules, shall govern these Terms and your use of the Service. Your use of the
						Application may also be subject to other local, state, national, or international laws.
					</p>
				</section>

				<section>
					<h2 class="font-serif text-xl font-semibold text-paper-text">Disputes Resolution</h2>
					<p class="mt-3 text-paper-text-light">
				...
				<section>
					<h2 class="font-serif text-xl font-semibold text-paper-text">
				...
				<section>
					<h2 class="font-serif text-xl font-semibold text-paper-text">Contact Us</h2>
					<p class="mt-3 text-paper-text-light">
						If you have any questions about these Terms and Conditions, You can contact us:
					</p>
					<ul class="mt-2 list-inside list-disc space-y-2 text-paper-text-light">
						<li>
							By visiting our website:
							<a
								href="https://fictioneer.app"
								target="_blank"
								rel="noopener noreferrer"
								class="text-paper-accent hover:underline"
							>
								fictioneer.app
							</a>
						</li>
		...
		<div class="mt-8 text-center">
			<a href={resolve('/')} class="btn-ghost">Back to home</a>
		</div>
	</div>
</div>
