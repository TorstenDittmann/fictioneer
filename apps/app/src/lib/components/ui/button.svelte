<script lang="ts">
	...
	const variant_classes = {
		...
		ghost:
			'bg-transparent text-gray-700 hover:bg-gray-100 focus:ring-gray-400 dark:text-gray-300 dark:hover:bg-gray-700 dark:focus:ring-gray-600'
	};
...
<BitsButton.Root {type} class={button_classes} {onclick} disabled={disabled || loading}>
	{#if loading}
